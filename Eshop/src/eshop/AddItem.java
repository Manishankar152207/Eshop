...
public class AddItem extends javax.swing.JFrame {
    ...
    public void getData(){
     ...
     try
        ...
        rec=st.executeQuery("select * from additem where itemcode='"+str+"'");
        if(rec.next())
            {
                JOptionPane.showMessageDialog(this,"Item with input code already Exit!");
    ...
    public void putData(){
        try{
            pst=con.prepareStatement("insert into additem values('"+a1+"','"+a2+"','"+a3+"','"+a4+"','"+a5+"','"+a6+"')");
            pst.executeUpdate();
        }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(578, 957, Short.MAX_VALUE))
        );
