 ...
 * @author acer
 */
public class AddCustomerDetail extends javax.swing.JFrame {
    Statement st;
    ...
    /**
     * Creates new form AddCustomerDetail
     */
     ...
     public void connect()
    {
     ...
     try
        ...
        rec=st.executeQuery("select * from addcustomerdetail where id='"+str+"'");
        if(rec.next())
            {
                JOptionPane.showMessageDialog(this,"Customer already Exit!!");
            ...
            dispose();
            AddCustomerDetail a7=new AddCustomerDetail();
            a7.show();
            }
        }
       catch(Exception ex)
    ...
    public void putData(){
        try{
          pst=con.prepareStatement("insert into addcustomerdetail values('"+a1+"','"+a2+"','"+a3+"','"+a4+"','"+a5+"','"+a6+"','"+a7+"','"+a8+"','"+a9+"','"+a10+"','"+a11+"')");
          pst.executeUpdate();
        }
        catch(Exception ex){
            System.out.println(ex);
  ...
  if(a1.equals("")||a2.equals("")||a3.equals("")||a4.equals("")||a5.equals("")||a6.equals("")||a7.equals("")||a8.equals("")||a9.equals("")||a10.equals("")||a11.equals(""))
  ...
  else 
   {
    ...
    UpdateCusDetail ob=new UpdateCusDetail();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCustomerDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddCustomerDetail().setVisible(true);
            }
        });
    }
