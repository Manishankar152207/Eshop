...
a2=jPasswordField4.getText();
a3=jPasswordField2.getText();
a4=jPasswordField3.getText();
}
public void connect()
{
try
...
String str1=jPasswordField4.getText();
rec=st.executeQuery("select * from CreateAcc where username='"+str+"' and pass='"+str1+"'");
if(rec.next())
{
showUpdate();
...
{
getData();
pst=con.prepareStatement("update CreateAcc set pass='"+a3+"',cpass='"+a4+"' where username='"+a1+"' and pass='"+a2+"'");
pst.executeUpdate();
}
 ...
 System.out.println(se);
    ...
    private void initComponents() {
        ...
        jPasswordField4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jPasswordField4, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    {
    jLabel6.setText("Please Fill all the Enteries.");
    }
   else 
    {
    connect();
